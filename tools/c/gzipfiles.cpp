...
int main(int argc,char *argv[])
{
  ...
  {
    printf("\n");
    printf("Using:/datacenter/tools/bin/gzipfiles pathname matchstr timeout\n\n");

    printf("Example:/datacenter/tools/bin/gzipfiles /log/idc \"*.log.20*\" 0.02\n");
    printf("        /datacenter/tools/bin/gzipfiles /tmp/idc/surfdata \"*.xml,*.json\" 0.01\n");
    printf("        /datacenter/tools/bin/procctl 300 /datacenter/tools/bin/gzipfiles /log/idc \"*.log.20*\" 0.02\n");
    printf("        /datacenter/tools/bin/procctl 300 /datacenter/tools/bin/gzipfiles /tmp/idc/surfdata \"*.xml,*.json\" 0.01\n\n");
