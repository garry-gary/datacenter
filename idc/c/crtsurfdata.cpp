...
int main(int argc,char *argv[])
{
  if (argc!=5) 
  {
    ...
    printf("Example:/datacenter/idc/bin/crtsurfdata /datacenter/idc/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata.log xml,json,csv\n\n");
...
bool CrtSurfFile(const char *outpath, const char *datafmt){
    ...
    for(int ii=0;ii<vsurfdata.size();ii++){
        ...
        if(strcmp(datafmt,"csv")==0){
            File.Fprintf("%s,%s,%.1f,%.1f,%.1f,%.1f,%.1f,%.1f,%.1f\n",vsurfdata[ii].obtid,vsurfdata[ii].ddatetime,vsurfdata[ii].t/10.0,vsurfdata[ii].p/10.0,vsurfdata[ii].u,vsurfdata[ii].wd,vsurfdata[ii].wf/10.0,vsurfdata[ii].r/10.0,vsurfdata[ii].vis/10.0);
        }

        if(strcmp(datafmt,"xml")==0){
            File.Fprintf("<obtid>%s</obtid><ddatetime>%s</ddatetime><t>%.1f</t><p>%.1f</p><u>%.1f</u><wd>%.1f</wd><wf>%.1f</wf><r>%.1f</r><vis>%.1f</vis><endl/>\n",vsurfdata[ii].obtid,vsurfdata[ii].ddatetime,vsurfdata[ii].t/10.0,vsurfdata[ii].p/10.0,vsurfdata[ii].u,vsurfdata[ii].wd,vsurfdata[ii].wf/10.0,vsurfdata[ii].r/10.0,vsurfdata[ii].vis/10.0);
        }

        if(strcmp(datafmt,"json")==0){
            File.Fprintf("{\"obtid\":\"%s\",\"ddatetime\":\"%s\",\"t\":\"%.1f\",\"p\":\"%.1f\",\"u\":\"%.1f\",\"wd\":\"%.1f\",\"wf\":\"%.1f\",\"r\":\"%.1f\",\"vis\":\"%.1f\"}",vsurfdata[ii].obtid,vsurfdata[ii].ddatetime,vsurfdata[ii].t/10.0,vsurfdata[ii].p/10.0,vsurfdata[ii].u,vsurfdata[ii].wd,vsurfdata[ii].wf/10.0,vsurfdata[ii].r/10.0,vsurfdata[ii].vis/10.0);
